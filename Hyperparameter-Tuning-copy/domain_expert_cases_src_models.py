...
# # Import the base pipeline (using src models version)
# from embeddings_pipeline_src_models import MixedEmbeddingPipeline
...
#         # Add GraphTransformer to available models
#         self.gnn_models_to_train = ['gcn', 'rggc', 'gat', 'graphtransformer']
...
from src.models.GNNmodelsRegression import (
    simple_GCN_res_plus_regression,
    simple_RGGC_plus_regression,
    simple_GAT_regression,
    simple_GraphTransformer_regression,
