...
class CaseImplementations:
    ...
    def __init__(self):
        ...
        self.syntrophic = [
            ...
            "d__Bacteria;p__Desulfobacterota;c__Desulfuromonadia;o__Geobacterales;f__Geobacteraceae;g__Geobacter",
    ...
    def run_case1(self, pipeline) -> Dict[str, Any]:
        ...
        # If LRP is enabled, reset to pre-LRP state to allow target-specific selection
        print(f"\n{'='*60}")
        print("RESETTING DATASET BETWEEN TARGETS")
        print(f"{'='*60}")
        if pipeline.dataset.lrp_feature_selection:
